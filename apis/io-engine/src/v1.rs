...
pub mod pool {
    pub use super::pb::{
        ...
        xata_raid_config, CreatePoolRequest, DestroyPoolRequest, ExportPoolRequest,
        GrowPoolRequest, GrowPoolResponse, ImportPoolRequest, ListPoolOptions, ListPoolsResponse,
        Pool, PoolMetadataArgs, PoolMetadataInfo, PoolState, PoolType, PoolTypeValue, Raid0Config,
        XataRaidConfig, XataRaidInfo,
    };
}
